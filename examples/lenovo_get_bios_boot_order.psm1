...
function lenovo_get_bios_boot_order
{
    <#
   .Synopsis
    Cmdlet used to Get bios boot order
   .DESCRIPTION
   ...
   .EXAMPLE
    lenovo_get_bios_boot_order -ip 10.10.10.10 -username USERID -password PASSW0RD 
   #>
    ...
    try
    {
        ...
        foreach($system_url_string in $system_url_collection)
        {
            ...
            # Get the boot order information
            $boot_order_info = @{}
