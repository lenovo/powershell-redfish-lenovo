...
function set_server_asset_tag
{
    <#
   .Synopsis
    Cmdlet used to Set server asset tag
   .DESCRIPTION
    Cmdlet used to Set server asset tag from BMC using Redfish API.Connection information can be specified via command parameter or configuration file.
