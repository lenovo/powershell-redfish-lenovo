...
function lenovo_mount_virtual_media
{
   ...
   .DESCRIPTION
    ...
    - fsprotocol: Specifies the protocol for uploading image or ISO
   ...
   #>
    ...
    (
        ...
        [Parameter(Mandatory=$False, HelpMessage='Specifies the protocol for uploading image or ISO. Support:["Samba", "NFS", "CIFS", "HTTP", "HTTPS", "SFTP", "FTP"].')]
        [string]$fsprotocol="",
        [Parameter(Mandatory=$False)]
        [string]$fsip="",
        [Parameter(Mandatory=$False)]
